...
class Pagination {
    ...
    updatePagination() {
        ...
        if (this.start == 1) {
            ...
            this.firstButton.style.color = "grey !important";
        ...
        document.querySelector(".btn-page.activepage").classList.remove('activepage');
        document.querySelector(".btn-page-" + this.currentPageNo).classList.add('activepage');

        this.totalRowCount = $('#emptbl >tbody >tr').length;
        console.log("my row count" + this.totalRowCount);
        this.paginationLabel.innerHTML = "Showing <span>" + this.start + "-" + (this.end) + "</span> of <span>" + this.totalNoOfRows + "</span>";
    }
}